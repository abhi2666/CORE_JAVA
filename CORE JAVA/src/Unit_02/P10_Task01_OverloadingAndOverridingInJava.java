...
// overloading can be defined as creating multiple methods/constructor with same name
// with different parameters and functionality if required.

// Overriding means when create same method as that of in super class in child class
// and define it again.
